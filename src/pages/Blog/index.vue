  ...
  <Layout>
    <div style="min-height: 600px">
        ...
        <template v-if="blogs && blogs.length>0">
            <el-card shadow="hover" v-for="blog in blogs" :key="blog.id" style="margin-bottom: 20px">
                <div slot="header">
                    <el-row>
                        <el-col :span="16">
                            <span>
                                <a style="text-decoration:none;cursor:pointer" @click="goDetails(blog.id)">
                                    <i class="el-icon-edit-outline"></i>&nbsp;&nbsp; {{blog.title}}
                                </a>
                            </span>
                        </el-col>
                        <el-col :span="8">
                            <div style="text-align: right;">
                                <el-button @click="$share('/blog/detail/'+blog.id)" style="padding: 3px 0" type="text" icon="el-icon-share"></el-button>
                ...
                <div v-if="blog.description" style="font-size: 1.1rem;line-height: 1.5;color: #303133;padding: 10px 0px 0px 0px">
                    {{blog.description}}
                </div>
            </el-card>
            <div style="text-align: center">
                <el-pagination @current-change="changePage" background layout="prev, pager, next" :current-page.sync="pageInfo.currentPage" :page-size="pageInfo.perPage"
